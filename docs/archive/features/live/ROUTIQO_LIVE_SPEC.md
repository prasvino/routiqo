> **Archived 2026-09-25.** The LIVE list plan is replaced by Journey, Spots and Ask Ahead in docs/PRODUCT.md. See [docs/archive/README.md](/docs/archive/README.md) and [docs/PRODUCT.md](/docs/PRODUCT.md). Kept as a historical record; not current requirements.
...
The mounted browser prerequisites are limited to private journey consent controls
(`BROWSER_LIVE_CONSENT_UI_SPEC.md`) and explicit route preparation
(`BROWSER_ROUTE_BINDING_UI_SPEC.md`). These do not enable public LIVE,
...
ADR 0031 resolves a curated anchor catalog against fresh guarded Valhalla vertices
