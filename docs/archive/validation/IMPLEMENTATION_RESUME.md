> **Archived 2026-09-25.** Paused-work handoff for the private LIVE sequence; replaced by the Phase 1 handoff in docs/validation/IMPLEMENTATION_RESUME.md. See [docs/archive/README.md](/docs/archive/README.md) and [docs/PRODUCT.md](/docs/PRODUCT.md). Kept as a historical record; not current requirements.
