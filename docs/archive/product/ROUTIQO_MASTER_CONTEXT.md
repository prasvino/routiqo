> **Archived 2026-09-25.** Replaced by docs/PRODUCT.md (product) and docs/architecture/ENGINEERING_CONTEXT.md (engineering sections). See [docs/archive/README.md](/docs/archive/README.md) and [docs/PRODUCT.md](/docs/PRODUCT.md). Kept as a historical record; not current requirements.
