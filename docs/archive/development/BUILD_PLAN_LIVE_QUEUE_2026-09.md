> **Archived 2026-09-25.** Execution queue and L0–L5 stages for the LIVE list, private consent/route preparation/Quick Signal flows and cohort publication, superseded by the Journey, Spots and Ask Ahead phases in docs/development/BUILD_PLAN.md. See [docs/archive/README.md](/docs/archive/README.md) and [docs/PRODUCT.md](/docs/PRODUCT.md). Kept as a historical record; not current requirements.
