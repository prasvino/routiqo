...
`ROUTE_ANCHOR_RESOLUTION_SPEC.md`, `ROUTE_BINDING_SPEC.md`, and ADRs 0026–0032. The private consent transport
...
internal path remains default off and has no public transport or grant issuer.
