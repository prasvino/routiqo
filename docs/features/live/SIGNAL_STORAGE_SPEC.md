...
> **Direction brief (2026-09-25):** Kept as storage infrastructure for Spot signals and posts. The 15-minute evidence lifetime becomes per-type lifetimes (about 1–2 hours traffic/queue, about 24 hours food/fuel/restroom) extended by "Still true?"; the consent participant is retired; content is public under per-room aliases rather than private receipts. See [PRODUCT.md](../../PRODUCT.md).
