...
4. **Journey and UI release reliability.** The batch 01–04 local web regressions
   and fixes above are complete. Broader cross-device restoration (explicit discard of refused
   actions is implemented on web, ADR 0063); authenticated journal/history/backup QA; storage failures,
