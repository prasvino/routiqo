...
> **Update (2026-09-25, ADR 0067, proposed):** the selected route of an active journey may be kept in one device-only, account-partitioned record for the Journey map and Spots ahead; everything else here stays memory-only.
